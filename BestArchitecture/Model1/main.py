#This file has the implementation of modified RESNET 18
...
def validate(epoch):
    ...
    if acc > best_acc:
        ...
        if not os.path.isdir('checkpoint'):
            os.mkdir('checkpoint')
        torch.save(state, './checkpoint/ckpt_FinalResult1_ConfusionMatrix_DP0_SGD.pth')
        best_acc = acc
...
if __name__ == '__main__': 
    ...
    if args.resume:
        ...
        checkpoint = torch.load('./checkpoint/ckpt_FinalResult1_ConfusionMatrix_DP0_SGD.pth')
    ...
    with open('./Confusion_Matrix/Plotckpt_FinalResult1_DP0_SGD.npy', 'wb') as f:
        np.save(f,cm) 
